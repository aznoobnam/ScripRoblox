...
ImageButton.Image = "https://www.roblox.com/library/5364475877/Anime"
...
do local GUI = game.CoreGui:FindFirstChild("AZNOOBNAMHUB");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
function Update:Window(text,logo,keybind)
	...
	local AZNOOBNAMHUB = Instance.new("ScreenGui")
	AZNOOBNAMHUB.Name = "AZNOOBNAMHUB"
	AZNOOBNAMHUB.Parent = game.CoreGui
	AZNOOBNAMHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = AZNOOBNAMHUB
	...
	local MAINCNR = Instance.new("UICorner")
	MAINCNR.Name = "MAINCNR"
	MAINCNR.Parent = Main
	...
	local TOPAGECNR = Instance.new("UICorner")
	TOPAGECNR.Name = "TOPAGECNR"
	TOPAGECNR.Parent = Top
	...
	local PAGECNR = Instance.new("UICorner")
	PAGECNR.Name = "PAGECNR"
	PAGECNR.Parent = Page
	...
	function uitab:Tab(text)
		...
		function main:Slider(text,min,max,set,callback)
			...
			local AOTHATDAY = Instance.new("Frame")
			local AOTHUATDEY = Instance.new("TextButton")
			...
			AOTHATDAY.Name = "AOTHATDAY"
			AOTHATDAY.Parent = sliderr
			AOTHATDAY.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			AOTHATDAY.BackgroundTransparency = 1.000
			AOTHATDAY.Size = UDim2.new(0, 468, 0, 29)

			AOTHUATDEY.Name = "AOTHUATDEY"
			AOTHUATDEY.Parent = sliderr
			AOTHUATDEY.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			AOTHUATDEY.BackgroundTransparency = 1.000
			AOTHUATDEY.Position = UDim2.new(0, 10, 0, 35)
			AOTHUATDEY.Size = UDim2.new(0, 448, 0, 5)
			AOTHUATDEY.Font = Enum.Font.SourceSans
			AOTHUATDEY.Text = ""
			AOTHUATDEY.TextColor3 = Color3.fromRGB(0, 0, 0)
			AOTHUATDEY.TextSize = 14.000

			bar.Name = "bar"
			bar.Parent = AOTHUATDEY
			...
			AOTHUATDEY.MouseButton1Down:Connect(function()
...
Main:Label("Hub made by aznoobnam")
...
spawn(function()
    ...
    Main:Toggle("Fast Attack ",true,function(value)
        ...
        Main:Toggle("Super Fast Attack",nil,function(value)
...
elseif _G.WhiteScreen == false then
   ...
   M:Seperator("Misc Mastery")
    ...
    spawn(function()
        ...
        M:Seperator("Order Sword")
    
    M:Toggle("Auto Order Sword", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:Toggle("Auto Order Sword Hop", _G.AutoOderSwordHop,function(value)
    ...
    M:Button("Buy Microchip Order Boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    M:Button("Start Go To Raid Order Boss",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
    
    M:Seperator("Elite Hunter")
...
spawn(function()
    ...
    P:Slider("Lock Bounty",1,30000000,2500000,function(value)
        _G.BountyLock = value
    end)
...
spawn(function()
    ...
    R:Button("Buy Chip",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    R:Toggle("Auto Start Raid",_G.Auto_StartRaid,function(value)
    ...
    D:Toggle("Grab Fruit",_G.BringFruit,function(value)
        ...
        D:Toggle("Bring All Fruit",_G.BringFruitBF,function(value)
...
Misc:Button("Color Haki",function()
    ...
    Misc:Dropdown("Selected Codes Reset stat",{"SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
        _G.CodeSelect = value
    end)
    ...
    Misc:Button("Unlock FPS",function()
     ...
     Misc:Button("Fake Skin",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
    ...
    Misc:Toggle("Infinite Ability(speedhack)",true,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:Toggle("Infinite Obversation Range(lag)",getgenv().InfiniteObRange,function(value)
    ...
    Misc:Toggle("Infinite Soru(don't use to fast)",getgenv().InfSoru,function(value)
...
spawn(function()
	...
	ESP:toggle("Fruit ESP",true,function(value)
		if value == true then
			for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
				pcall(function()
					if DevilFruitESP then
