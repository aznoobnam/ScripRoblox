...
function Update:Window(text,logo,keybind)
	...
	local TOPCNR = Instance.new("UICorner")
	TOPCNR.Name = "TOPCNR"
	TOPCNR.Parent = Top
...
elseif _G.WhiteScreen == false then
   ...
   M:Seperator("Misc Mastery")
    ...
    M:Toggle("Auto Oder Sword", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:Toggle("Auto Oder Sword Hop", _G.AutoOderSwordHop,function(value)
